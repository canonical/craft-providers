...
Craft Providers has a community from all over the world, and we welcome all
contributions.

Contributing offers an opportunity to polish your technical skills, develop as a
professional, and get involved in the growing open source community. Craft Providers
...
The Starcraft team at Canonical sets the direction and priorities of Craft Providers.
They take responsibility for its stewardship and health.

Before you start work on Craft Providers, there are three documents for you to digest.
...
Craft Providers is licensed under [LGPL-3.0](LICENSE).

## Report an issue or open a request

If you find a bug or feature gap in Craft Providers, look for it in the [project's GitHub
issues](https://github.com/canonical/craft-providers/issues) first. If you have fresh
input, add your voice to the issue.

If the bug or feature doesn't have an issue, we invite you to [open
one](https://github.com/canonical/craft-providers/issues/new/choose).

## Apply for a bounty

Craft Providers has a parallel stream of materially-rewarding work in the form of
...
GitHub issue. The Craft Providers maintainers review all proposals for technical
soundness. If your proposal is accepted, they will assign you the bounty, after which
you can begin work.

## Set up for development

Craft Providers uses a forking, feature-based workflow. Most work on Craft Providers
...
Start by [creating a personal fork](https://github.com/canonical/craft-providers/fork)
...
```bash
git clone git@github.com:<username>/craft-providers --recurse-submodules
cd craft-providers
git remote add upstream git@github.com:canonical/craft-providers
git fetch upstream
```
...
```bash
git clone https://github.com/<username>/craft-providers --recurse-submodules
cd craft-providers
git remote add upstream https://github.com/canonical/craft-providers
git fetch upstream
```
...
All significant work in Craft Providers should be tied to an existing issue or ticket.

Once you find an issue that you'd like to work on, it's best to reach out so that a
Craft Providers maintainer can assign the ticket to you before starting. This process
...
Craft Providers maintainer will assign it to you.

If you don't find a related issue, [open
one](https://github.com/canonical/craft-providers/issues/new/choose) and indicate that
you're interested in taking it on. When creating the issue, be sure to add any relevant
labels. A Craft Providers maintainer will then review the issue and assign it to you.
...
on it has been started, or that it fits into an existing plan. Often, you will save
time and effort by checking for prior work.

Once you've found or created an issue you'd like to take on, propose your solution in
the issue's thread. In your proposal, describe a plan for the change, its tests, and
its documentation. If the feature warrants a new page in the documentation, propose a
[Diátaxis](https://diataxis.fr) category for the page. A Craft Providers maintainer
...
Craft Providers' test suite includes unit and integration tests. If you're not sure which
...
The Craft Providers maintainers try to review every PR in a timely manner, typically
